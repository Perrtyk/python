...
# Configure the input frame rows and columns
input_frame.rowconfigure(0, weight=0)
input_frame.rowconfigure(1, weight=1, pad=5)  # decreased pady value
input_frame.rowconfigure(2, weight=1, pad=5)  # decreased pady value
input_frame.rowconfigure(3, weight=1, pad=5)  # decreased pady value
...
results_frame.grid(column=0, row=1, sticky='nsew')
