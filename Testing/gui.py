...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Not NetHawk", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, text="Start Scan", command=self.start_scan_botton)
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, text="Stop Scan", command=self.stop_scan_botton)
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)
        self.sidebar_button_3 = customtkinter.CTkButton(self.sidebar_frame, text="Save Results", command=self.save_results)
        ...
        self.label_treeview = customtkinter.CTkLabel(master=self.main_entry_frame, width=250, text="Results",
                                                     font=customtkinter.CTkFont(size=14, weight="bold"))
        self.label_treeview.grid(row=1, column=0, columnspan=4, rowspan=1, padx=(10, 0), pady=(10, 0), sticky='new')
        ...
        self.console_output.grid_rowconfigure(2, weight=1)
        self.console_output.grid(row=3, column=0, columnspan=4, padx=(20, 0), pady=(20, 0), sticky="sew")

        # row 4 - add progress bar from its frame
        self.progressbar_1 = customtkinter.CTkProgressBar(self.main_entry_frame)
        self.progressbar_1.grid(row=4, column=0, columnspan=4, padx=(20, 10), pady=(10, 10), sticky="sew")
        ...
        self.label_radio_group = customtkinter.CTkLabel(master=self.radiobutton_frame, text="Ping Threshold", font=customtkinter.CTkFont(size=14, weight="bold"))
        self.label_radio_group.grid(row=0, column=2, columnspan=1, padx=10, pady=10, sticky="ew")
        self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="25ms", variable=self.radio_var, value=0)
        self.radio_button_1.grid(row=1, column=2, pady=10, padx=20, sticky="n")
        self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="50ms", variable=self.radio_var, value=1)
        self.radio_button_2.grid(row=2, column=2, pady=10, padx=20, sticky="n")
        self.radio_button_3 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="100ms", variable=self.radio_var, value=2)
        self.radio_button_3.grid(row=3, column=2, pady=10, padx=20, sticky="n")
        self.radio_button_4 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="250ms", variable=self.radio_var, value=3)
...
#        self.progressbar_1.grid(row=1, column=0, padx=(20, 10), pady=(10, 10), sticky="sew")
...
#            self.scrollable_frame_switches.append(switch)
        ...
        self.label_checkbox_group = customtkinter.CTkLabel(master=self.checkbox_slider_frame, text="Options", font=customtkinter.CTkFont(size=14, weight="bold"))
        ...
        self.exit_button_1 = customtkinter.CTkButton(master=self, fg_color="transparent", text="Exit", border_width=2,
                                                     text_color=("gray10", "#DCE4EE"), command=self.exit)
